...
make -f makefile.linux-mingw $MAKEOPTS DEPSDIR=$STAGING robotsexnickelsd.exe USE_UPNP=0 DEBUGFLAGS="-frandom-seed=robotsexnickels" USE_SSE2=1
$HOST-strip *.exe
rm -rf $OUTDIR/daemon
mkdir $OUTDIR/daemon
