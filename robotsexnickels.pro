TEMPLATE = app
TARGET = robotsexnickels-qt
macx:TARGET = "RobotSexNickels-Qt"
VERSION = 0.1.3.1
...
QT += testlib
TARGET = robotsexnickels-qt_test
...
macx:ICON = src/qt/res/icons/robotsexnickels.icns
