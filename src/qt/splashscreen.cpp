    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText3   = QChar(0xA9)+QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The RobotSexNickels developers"));
    ...
    pixPaint.setPen(QColor(24,43,28));
