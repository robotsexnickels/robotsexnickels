...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 RSN
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 RSN mininput
/** No amount larger than this (in satoshi) is valid
    This will be sufficient for over 200 years,
    at some point the protocol will require a larger datatype anyway */
static const int64 MAX_MONEY = 3826646 * COIN;
