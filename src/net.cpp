...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "RobotSexNickels " + FormatFullVersion();
...
static const char *strMainNetOnionSeed[][1] = {
    {"zplz3dp55p7pqjpd.onion"},
    {"dinaagsq35pip3lt.onion"},
    {"2eu2expsz3cm4724.onion"},
    {NULL}
};

static const char *strTestNetOnionSeed[][1] = {
    {"mjocghqmd7lvfy4e.onion"},
    {"d7ot7uras2czmykt.onion"},
    {"365zlb7iuhgf5zat.onion"},
    {NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. RobotSexNickels is probably already running."), addrBind.ToString().c_str());
        else
